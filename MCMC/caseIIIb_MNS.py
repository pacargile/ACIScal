...
class ACIS(object):
    ...
    def run_nestle(self,outfile='TEST.dat'):
        ...
        self.outfile.write('ITER Teff Dist Rad NH arfsc1 arfsc2 arfsc3 arfsc4 log(z) log(wt) \n')
        # Start sampler
        print('Start Nestle')
        self.startmct = datetime.now()
...
if __name__ == '__main__':
    ...
    c = ACIS()
    # outfile names
    outfile = 'ACIScal_I_MNS_CASEIIIb.out'
    outh5file = 'ACIScal_I_MNS_CASEIIIb.h5'
    # run the MCMC
